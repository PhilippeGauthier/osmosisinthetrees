            ...
            addBase({
                ...
                addComponents({
                    ".fluid-grid": {
                        ...
                        "--padding-left":
                            "clamp(calc(env(safe-area-inset-left, 0rem) + 1rem), 2vw, calc(env(safe-area-inset-left, 0rem) + 2rem))",
                        "--padding-right":
                            "clamp(calc(env(safe-area-inset-right, 0rem) + 1rem), 2vw, calc(env(safe-area-inset-right, 0rem) + 2rem))",
